...
{
    Item item{ .position{5, 0}, .width{0.6 } };
    Gatherer gatherer{ .start_pos{0, 0}, .end_pos{7, 0}, .width = 0.6 };
...
{
    Item item{ .position{5, 0}, .width = 0.6 };
    Gatherer gatherer{ .start_pos{0, 0}, .end_pos{5, 0}, .width = 0.6 };
    CatchItemGathererProvider provider;
    provider.AddItem(item);
    provider.AddGatherer(gatherer);
    auto events = FindGatherEvents(provider);
...
{
    Item item{ .position{0, 6}, .width = 0.6 };
    Gatherer gatherer{ .start_pos{0, 0}, .end_pos{0, 15}, .width = 0.6 };
    CatchItemGathererProvider provider;
    provider.AddItem(item);
    provider.AddGatherer(gatherer);
    auto events = FindGatherEvents(provider);
...
{
    Item item1{ .position{6, 0}, .width = 0.6 };
    Item item2{ .position{2, 0}, .width = 0.6 };
    Gatherer gatherer{ .start_pos{0, 0}, .end_pos{15, 0}, .width = 0.6 };
    CatchItemGathererProvider provider;
...
{
    Item item1{ .position{7, 0}, .width = 0.6 };
    Item item2{ .position{1, 0}, .width = 0.6 };
    Gatherer gatherer{ .start_pos{0, 0}, .end_pos{4, 0}, .width = 0.6 };
    CatchItemGathererProvider provider;
    provider.AddItem(item1);
    provider.AddItem(item2);
    provider.AddGatherer(gatherer);
...
{
    Item item1{ .position{0, 8.5}, .width = 0.6 };
    Item item2{ .position{3.4, 0}, .width = 0.6 };
    Gatherer gatherer1{ .start_pos{0, 0}, .end_pos{12, 0}, .width = 0.6 };
    Gatherer gatherer2{ .start_pos{0, 0}, .end_pos{0, 15}, .width = 0.6 };
    CatchItemGathererProvider provider;
    provider.AddItem(item1);
    provider.AddItem(item2);
